      ...
      <div className="absolute -left-4 md:-left-20 top-3">
        ...
        >
          <motion.div
            transition={{ duration: 0.2, delay: 0.5 }}
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? "white" : "rgb(242 113 33)",
              borderColor: scrollYProgress.get() > 0 ? "white" : "rgb(217 86 18)",
            }}
        ...
        <svg viewBox={`0 0 20 ${svgHeight}`} width="20" height={svgHeight} className="ml-4 block" aria-hidden="true">
          ...
          <motion.path d={`M 1 0V -36 l 18 24 V ${svgHeight * 0.8} l -18 24V ${svgHeight}`} fill="none" stroke="url(#tb-gradient)" strokeWidth="1.25" className="motion-reduce:hidden" transition={{ duration: 10 }} />
          <defs>
            <motion.linearGradient id="tb-gradient" gradientUnits="userSpaceOnUse" x1="0" x2="0" y1={y1} y2={y2}>
              <stop stopColor="#F27121" stopOpacity="0" />
              <stop stopColor="#F27121" />
              <stop offset="0.325" stopColor="#9333ea" />
