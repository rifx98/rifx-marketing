...
export async function sendAdminEscalationEmail(to: string, customerName: string, customerPhone: string, customerMessage: string): Promise<boolean> {
  ...
  const dashboardUrl = process.env.NEXT_PUBLIC_APP_URL ? `${process.env.NEXT_PUBLIC_APP_URL}/admin/chat` : 'https://rifx-marketing.com/admin/chat';
      ...
      <td align="center">
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background-color:#ffffff;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:10px 40px 20px;text-align:center;">
              <h1 style="margin:0;color:#111827;font-size:26px;font-weight:700;line-height:1.3;">
                <span style="background-color:#fef08a;padding:2px 8px;border-radius:4px;">Atención</span> requerida
              </h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:10px 40px 30px;text-align:center;">
              <div style="background-color:#f3f4f6;border-radius:8px;padding:24px;display:inline-block;width:100%;max-width:320px;text-align:left;">
                <p style="margin:0 0 10px;color:#111827;font-size:16px;"><strong>👤 Cliente:</strong> ${customerName}</p>
                <p style="margin:0;color:#111827;font-size:16px;"><strong>📞 Teléfono:</strong> +${customerPhone}</p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 40px 30px;text-align:center;">
              ...
              <p style="margin:0 0 16px;color:#374151;font-size:15px;line-height:1.6;">
                Un cliente ha solicitado hablar con un humano. El bot inteligente ha sido <span style="background-color:#fef08a;padding:2px 6px;border-radius:3px;font-weight:bold;color:#111827;">pausado</span> temporalmente para este contacto.
              </p>
              
              <div style="margin:24px 0;padding:16px;background-color:#ffffff;border:1px solid #e5e7eb;border-radius:8px;border-left:4px solid #facc15;text-align:left;">
                <p style="margin:0 0 8px;font-size:14px;color:#6b7280;font-weight:600;text-transform:uppercase;">Último mensaje:</p>
                <p style="margin:0;font-size:15px;color:#111827;font-style:italic;">"${customerMessage.substring(0, 500)}"</p>
              </div>
          ...
          <tr>
            <td style="padding:0 40px 40px;text-align:center;">
              <p style="margin:0;color:#374151;font-size:15px;line-height:1.6;">
                Saludos,<br>
                <strong>El sistema automático de RIFX</strong>
              </p>
            </td>
          </tr>
