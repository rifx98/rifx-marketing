...
export default function Footer() {
  ...
  return (
    <footer className="bg-white pt-20 pb-12 border-t border-black/5 relative z-20" data-purpose="main-footer" data-no-reveal>
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          <div className="flex items-center space-x-2 mb-4">
            ...
            <span className="text-[#0b1229] font-extrabold text-xl tracking-wider uppercase">Rifx Marketing</span>
          </div>
        ...
        {/* Contact Info */}
        <div>
          <h4 className="text-[#0b1229] font-bold mb-6 text-sm uppercase tracking-widest">Contactos</h4>
        ...
        {/* Social */}
        <div>
          <h4 className="text-[#0b1229] font-bold mb-6 text-sm uppercase tracking-widest">Redes Galácticas</h4>
          <div className="flex space-x-4">
            {/* TikTok */}
            <a className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center hover:text-[#F27121] text-[#0b1229] transition-colors" href="#" aria-label="TikTok">
            ...
            {/* Facebook */}
            <a className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center hover:text-[#F27121] text-[#0b1229] transition-colors" href="#" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            {/* YouTube */}
            <a className="w-10 h-10 rounded-full bg-black/5 flex items-center justify-center hover:text-[#F27121] text-[#0b1229] transition-colors" href="#" aria-label="YouTube">
      ...
      <div className="mt-16 pt-8 border-t border-black/5 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 gap-4">
        <p className="max-w-7xl mx-auto px-8 w-full flex justify-between">
          ...
          <span className="flex space-x-6">
            <Link className="hover:text-[#0b1229] transition-colors" href="/terminos">Aviso Legal</Link>
            <Link className="hover:text-[#0b1229] transition-colors" href="/politica-privacidad">Privacidad</Link>
            <Link className="hover:text-[#0b1229] transition-colors" href="/politica-privacidad#cookies">Cookies</Link>
          </span>
        </p>
      </div>
    </footer>
