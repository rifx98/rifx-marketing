                  ...
                  <div className="p-6 space-y-4 bg-white dark:bg-slate-900">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full bg-slate-50 dark:bg-slate-800/80 border rounded-xl px-4 py-2.5 text-sm font-normal text-slate-800 dark:text-slate-100 focus:ring-2 outline-none transition-all ${
                      ...
                      />
                      {checkIsNonWorkingDay(rescheduleDate) && (
                        <div className="mt-2.5 p-3 bg-rose-500/10 dark:bg-rose-950/30 border border-rose-500/20 dark:border-rose-800/40 rounded-xl flex items-center gap-2 text-xs text-rose-600 dark:text-rose-400 font-medium">
                    ...
                    <div>
                      {checkIsNonWorkingDay(rescheduleDate) ? (
                        <div className="p-3.5 bg-rose-500/5 dark:bg-rose-950/20 border border-dashed border-rose-200 dark:border-rose-900/40 rounded-xl text-center text-xs text-rose-600 dark:text-rose-400 font-medium">
                          {language === 'en'
                    ...
                    <div className="flex items-center justify-end gap-3 pt-2">
                      <button
                        ...
                        className="px-5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-100 dark:hover:bg-slate-800 transition-all text-xs cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-medium shadow-sm shadow-blue-500/20 disabled:opacity-50 transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                      >
