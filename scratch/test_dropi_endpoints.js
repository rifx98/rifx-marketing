...
async function main() {
  ...
  const endpoints = [
    'https://api.dropi.co/api/v1/orders/myorders',
    'https://api.dropi.co/api/v1/orders',
    'https://api.dropi.co/api/v1/orders/create',
    'https://api.dropi.co/api/v1/order',
    'https://api.dropi.co/api/v1/order/create',
    'https://api.dropi.co/api/v1/public/orders',
    'https://api.dropi.co/api/v1/myorders'
  ];
